                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jButt_Order, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(69, 69, 69))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(53, 53, 53)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButt_Receipt, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                if (!isNumeric) {//숫자가 아니라면
                    ...
                    if (Integer.parseInt(FoodNameList[3]) < priceCount) {//입력받은값이 현재수량보다 많다면
                        ...
                        try {
                            ...
                            line = String.format("%s/%s/%d/%d/%d%n", FoodNameList[0], FoodNameList[1], Integer.parseInt(FoodNameList[2]), priceCount, sum);
                        ...
                        line2 += String.format("음식종류=>%s%n"
                                ...
                                + "주문한 수량=>%d%n"
                                + "해당음식 총가격=>%d%n",
                                FoodNameList[0], FoodNameList[1], Integer.parseInt(FoodNameList[2]), priceCount, sum);
                        line2 += "------------------\n\n";
